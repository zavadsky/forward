...
class ArithmeticCoderBase {
	...
	protected: virtual void update(const FrequencyTable &freqs, std::uint64_t symbol);
...
class ArithmeticDecoder final : private ArithmeticCoderBase {
	...
	public: std::uint64_t read(const FrequencyTable &freqs);
    ...
    public: uint64_t decodeCdelta();

	public: uint64_t readBit();
 ...
 */
class ArithmeticEncoder : private ArithmeticCoderBase {
	...
	public: void write(const FrequencyTable &freqs, std::uint64_t symbol);
    ...
    public: void encodeCdelta(uint64_t x);
	...
	public: virtual int Compress_c_table(UniversalCode*,UniversalCode*,UniversalCode*,UniversalCode*){};
